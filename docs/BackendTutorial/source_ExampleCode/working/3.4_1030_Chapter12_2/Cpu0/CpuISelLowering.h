//===-- CpuISelLowering.h - Cpu DAG Lowering Interface --------*- C++ -*-===//
//
...
#ifndef CpuISELLOWERING_H
#define CpuISELLOWERING_H
...
namespace llvm {
  namespace CpuISD {
    enum NodeType {
      ...
      // No relation with Cpu Hi register
      Hi,
      // Get the Lower 16 bits from a 32-bit immediate
      // No relation with Cpu Lo register
      Lo,
  ...
  class CpuTargetLowering : public TargetLowering  {
  public:
    explicit CpuTargetLowering(CpuTargetMachine &TM);
