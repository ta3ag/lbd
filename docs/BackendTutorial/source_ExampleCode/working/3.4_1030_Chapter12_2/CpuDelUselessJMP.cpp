//===-- CpuDelUselessJMP.cpp - Cpu DelJmp -------------------------------===//
//
...
runOnMachineBasicBlock(MachineBasicBlock &MBB, MachineBasicBlock &MBBN) {
  ...
  if (I->getOpcode() == Cpu::JMP && I->getOperand(0).getMBB() == &MBBN) {
...
/// createCpuDelJmpPass - Returns a pass that DelJmp in Cpu MachineFunctions
FunctionPass *llvm::createCpuDelJmpPass(CpuTargetMachine &tm) {
