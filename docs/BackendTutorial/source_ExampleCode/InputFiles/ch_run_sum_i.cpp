...
// /home/Gamma/test/lld_0816/cmake_debug_build/bin/clang -target mips-unknown-linux-gnu -c ch_run_sum_i.cpp -emit-llvm -o ch_run_sum_i.bc
// /home/Gamma/test/lld_0816/cmake_debug_build/bin/llc -march=cpu0 -relocation-model=static -filetype=obj ch_run_sum_i.bc -o ch_run_sum_i.cpu0.o
