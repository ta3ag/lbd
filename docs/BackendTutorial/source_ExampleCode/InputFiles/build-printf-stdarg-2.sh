...
${TOOLDIR}/llc -march=${cpu} -relocation-model=static -filetype=obj start.ll -o start.cpu0.o
${TOOLDIR}/llc -march=${cpu} -relocation-model=static -filetype=obj printf-stdarg.bc -o printf-stdarg.cpu0.o
${TOOLDIR}/llc -march=${cpu} -relocation-model=static -filetype=obj printf-stdarg-2.bc -o printf-stdarg-2.cpu0.o
