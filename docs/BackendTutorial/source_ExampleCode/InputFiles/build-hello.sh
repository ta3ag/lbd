...
/usr/local/llvm/release/cmake_debug_build/bin/clang -target mips-unknown-linux-gnu -c ch_hello.c -emit-llvm -o ch_hello.bc
...
${TOOLDIR}/llc -march=cpu0 -mcpu=${cpu} -relocation-model=static -filetype=obj ch_hello.bc -o ch_hello.cpu0.o
${TOOLDIR}/lld -flavor gnu -target cpu0-unknown-linux-gnu start.cpu0.o printf-stdarg.cpu0.o ch_hello.cpu0.o -o a.out
