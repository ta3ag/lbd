...
dynamic linker is not exist at this point. We have check this implementation 
by check Mips ABI and lldb or gdb with X86 platform. Finding them all use the 
plt as the dynamic link implementation. 
...
After linker, the plt for dynamic link function _Z5fooii and _Z3barv will be 
solved and ELF file will like the following,
...
00400720 <_Z3barv@plt>:
  ...
  400724:	lw	t9,2764($8)
  400728:	jr	t9
  40072c:	addiu	$9,$8,2764

00400730 <_Z3fooii@plt>:
  400730:	lui	$8,0x41
  400734:	lw	t9,2768($8)
  400738:	jr	t9
  40073c:	addiu	$9,$8,2768

We reserved $9 as the register which content is the function name information.
It's the offset value at .dynsym section of ELF file. For this example, in 
_Z3fooii@plt, the contents of address 0x410ad0 (2668=0xad0) include the 
information of dynamic function _Z3fooii. Usually the information include which 
library and offset value in this library. This information can be got and save 
in ELF file in link time.


Dynamic link principle
~~~~~~~~~~~~~~~~~~~~~~~
...
.. figure:: ../Fig/elf/2.png
    ...
    Memory map: the program main is loaded to memory

As you can see, the first time, function call, a = foo(1,2), is implemented by
instruction "ld $7, %call24(_Z3fooii@plt)($gp)", "add $6, $zero, $7" and 
"jalr $6". After "jalr $6", PC counter jump to "00400730 <_Z3fooii@plt>". 
After this plt instructions executed, the 
...
0000000100000f3e <__Z3barv$stub>:
   100000f3e:	ff 25 cc 00 00 00    	jmpq   *0xcc(%rip)        # 100001010 <__Z3barv$stub>

0000000100000f44 <__Z3fooii$stub>:
   100000f44:	ff 25 ce 00 00 00    	jmpq   *0xce(%rip)        # 100001018 <__Z3fooii$stub>
...
0000000100000f4c <__TEXT.__stub_helper>:
   ...
   100000f55:	ff 25 a5 00 00 00    	jmpq   *0xa5(%rip)        # 100001000 <dyld_stub_binder$stub>
   100000f5b:	90                   	nop
...
(lldb) run main
Process 702 launched: '/Users/Jonathan/test/lbd/docs/BackendTutorial/LLVMBackendTutorialExampleCode/InputFiles/a.out' (x86_64)
...
Process 753 stopped
* thread #1: tid = 0x1c03, 0x0000000100000f09 a.out`main + 25 at main.cpp:7, stop reason = breakpoint 1.1
...
(lldb) stepi
Process 753 stopped
* thread #1: tid = 0x1c03, 0x0000000100000f44 a.out`foo(int, int), stop reason = instruction step into
...
(lldb) stepi
Process 859 stopped
* thread #1: tid = 0x1c03, 0x0000000100000f66 a.out, stop reason = instruction step into
    frame #0: 0x0000000100000f66 a.out
...
Process 859 stopped
* thread #1: tid = 0x1c03, 0x0000000100000f6b a.out, stop reason = instruction step into
    frame #0: 0x0000000100000f6b a.out
-> 0x100000f6b:  jmpq   0x100000f4c
-> 0x100000f6b:  jmpq   0x100000f4c
   0x100000f70:  addb   %al, (%rax)
   0x100000f72:  addb   %al, (%rax)
...
(lldb) stepi
Process 859 stopped
* thread #1: tid = 0x1c03, 0x0000000100000f4c a.out, stop reason = instruction step into
    frame #0: 0x0000000100000f4c a.out
-> 0x100000f4c:  leaq   181(%rip), %r11           ; (void *)0x0000000000000000
   0x100000f53:  pushq  %r11
   0x100000f55:  jmpq   *165(%rip)                ; (void *)0x00007fff978da878: dyld_stub_binder
   0x100000f5b:  nop    
-> 0x100000f4c:  leaq   181(%rip), %r11           ; (void *)0x0000000000000000
   0x100000f53:  pushq  %r11
   0x100000f55:  jmpq   *165(%rip)                ; (void *)0x00007fff978da878: dyld_stub_binder
...
(lldb) 
Process 859 stopped
* thread #1: tid = 0x1c03, 0x0000000100000f53 a.out, stop reason = instruction step into
    frame #0: 0x0000000100000f53 a.out
-> 0x100000f53:  pushq  %r11
   0x100000f55:  jmpq   *165(%rip)                ; (void *)0x00007fff978da878: dyld_stub_binder
   0x100000f5b:  nop    
   0x100000f5c:  pushq  $0
...
(lldb) 
Process 859 stopped
* thread #1: tid = 0x1c03, 0x0000000100000f55 a.out, stop reason = instruction step into
    frame #0: 0x0000000100000f55 a.out
-> 0x100000f55:  jmpq   *165(%rip)                ; (void *)0x00007fff978da878: dyld_stub_binder
   0x100000f5b:  nop    
   0x100000f5c:  pushq  $0
...
(lldb) 
Process 859 stopped
* thread #1: tid = 0x1c03, 0x00007fff978da878 libdyld.dylib`dyld_stub_binder, stop reason = instruction step into
...
Process 753 stopped
* thread #1: tid = 0x1c03, 0x0000000100000f1b a.out`main + 43 at main.cpp:8, stop reason = breakpoint 2.1
...
* thread #1: tid = 0x1c03, 0x0000000100000f44 a.out`foo(int, int), stop reason = instruction step into
    frame #0: 0x0000000100000f44 a.out`foo(int, int)
a.out`symbol stub for: foo(int, int):
-> 0x100000f44:  jmpq   *206(%rip)                ; (void *)0x0000000100003f20: foo(int, int) at /Users/Jonathan/test/lbd/docs/BackendTutorial/LLVMBackendTutorialExampleCode/InputFiles/foobar.cpp:3
a.out`symbol stub for: foo(int, int):
-> 0x100000f44:  jmpq   *206(%rip)                ; (void *)0x0000000100003f20: foo(int, int) at /Users/Jonathan/test/lbd/docs/BackendTutorial/LLVMBackendTutorialExampleCode/InputFiles/foobar.cpp:3
   0x100000f4a:  addb   %al, (%rax)
   0x100000f4c:  addb   %al, (%rax)
...
(lldb) stepi
Process 753 stopped
* thread #1: tid = 0x1c03, 0x0000000100003f20 libfoobar.so`foo(x1=0, x2=3) at foobar.cpp:3, stop reason = instruction step into
