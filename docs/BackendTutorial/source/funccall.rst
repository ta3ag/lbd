...
2. Create Cpu0ISD::Ret node in LowerReturn() which is called when meet function
   ...
   create DAGs (Cpu0ISD::Ret (CopyToReg %X, %V0, %Y), %V0, Flag).
...
4. Expand the Cpu0::RetLR into instruction **ret $lr** in "Expand ISel Pseudo-
   instructions" stage by the code in Chapter8_3/Cpu0InstrInfo.cpp as above.
