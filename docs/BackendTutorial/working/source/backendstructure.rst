...
.. code-block:: c++
  ...
  //===----------------------------------------------------------------------===//
  def IsCpu032I   :     Predicate<"Subtarget.isCpu032I()">,
                        AssemblerPredicate<"FeatureCpu032II">;
  def IsCpu032II  :     Predicate<"Subtarget.isCpu032II()">,
                        AssemblerPredicate<"FeatureCpu032II">;
...
We can apply :num:`Figure #backendstructure-f8` Instruction Tree Patterns to get the 
