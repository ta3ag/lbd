; RUN: llc -march=mipsel -mcpu=cpu0 -relocation-model=static < %s | FileCheck %s -check-prefix=CHECK_ADDIU
...
; CHECK_ADDIU: 	addiu	${{[0-9]+}}, ${{[0-9]+}}, 5
; CHECK_ADDIU: 	addiu	${{[0-9]+}}, ${{[0-9]+}}, -5
; CHECK_ADDIU: 	addiu	${{[0-9]+}}, ${{[0-9]+}}, 10000
; CHECK_ADDIU: 	addiu	${{[0-9]+}}, ${{[0-9]+}}, -10000
  ret void
}
