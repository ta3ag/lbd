...
; cpu032I:  jne $sw, $BB{{[0-9]+}}_{{[0-9]}}
; cpu032II:  bne ${{[0-9]+}}, $zero, $BB{{[0-9]+}}_{{[0-9]}}
...
; cpu032II:  beq ${{[0-9]+}}, $zero, $BB{{[0-9]+}}_{{[0-9]}}
...
; cpu032I:  cmp	$sw, ${{[0-9]+}}, ${{[0-9]+}}
; cpu032I:  jlt $sw, $BB{{[0-9]+}}_{{[0-9]}}
; cpu032II:  slti	$[[T0:[0-9]+]], ${{[0-9]+}}, 1
; cpu032II:  bne $[[T0]], $zero, $BB{{[0-9]+}}_{{[0-9]}}
...
; cpu032I:  cmp	$sw, ${{[0-9]+}}, ${{[0-9]+}}
; cpu032I:  jge $sw, $BB{{[0-9]+}}_{{[0-9]}}
; cpu032II:  slt	$[[T0:[0-9]+]], ${{[0-9]+}}, ${{[0-9]+}}
; cpu032II:  beq $[[T0]], $zero, $BB{{[0-9]+}}_{{[0-9]}}
