...
entry:
; Prolog
; CHECK:	lui	$[[T0:[0-9]+]], 32768
; CHECK:	addiu	$[[T1:[0-9]+]], $[[T0]], 8
; CHECK:	addu	$sp, $sp, $[[T1]]
; CHECK:	.cfi_def_cfa_offset 2147483640

; Epilog
; CHECK:	lui	$[[T2:[0-9]+]], 32767
; CHECK:	ori	$[[T3:[0-9]+]], $[[T2]], 65528
; CHECK:	addu	$sp, $sp, $[[T3]]
...
entry:
; Prolog
; CHECK:	lui	$[[T0:[0-9]+]], 28671
; CHECK:	ori	$[[T1:[0-9]+]], $[[T0]], 32768
; CHECK:	addu	$sp, $sp, $[[T1]]
; CHECK:	.cfi_def_cfa_offset -1879015424

; Epilog
; CHECK:	lui	$[[T2:[0-9]+]], 36865
; CHECK:	addiu	$[[T3:[0-9]+]], $[[T2]], -32768
; CHECK:	addu	$sp, $sp, $[[T3]]
