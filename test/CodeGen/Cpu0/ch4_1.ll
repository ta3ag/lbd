...
; CHECK:  subu  ${{[0-9]+}}, ${{[0-9]+}}, ${{[0-9]+}}
  %sub = sub nsw i32 %2, %3
  store i32 %sub, i32* %d, align 4
  %4 = load i32* %a, align 4
  %5 = load i32* %b, align 4
; CHECK:  mul ${{[0-9]+}}, ${{[0-9]+}}, ${{[0-9]+}}
  %mul = mul nsw i32 %4, %5
