...
; STATIC_LARGE:  lui	$[[T0:[0-9]+]], %hi(gI)
; STATIC_LARGE:  addiu	$[[T1:[0-9]+]], $[[T0]], %lo(gI)
; STATIC_LARGE:  ld	${{[0-9]+}}, 0($[[T1]])
; STATIC_SMALL:  addiu	$[[T0:[0-9]+]], $gp, %gp_rel(gI)
; STATIC_SMALL:  ld	${{[0-9]+}}, 0($[[T0]])
; PIC_LARGE:  .cpload	$t9
; PIC_LARGE:  lui	$[[T0:[0-9]+]], %got_hi(gI)
; PIC_LARGE:  addu	$[[T1:[0-9]+]], $[[T0]], $gp
; PIC_LARGE:  ld	${{[0-9]+}}, %got_lo(gI)($[[T1]])
; PIC_SMALL:  .cpload	$t9
; PIC_SMALL:  ld	$[[T0:[0-9]+]], %got(gI)($gp)
; PIC_SMALL:  ld	${{[0-9]+}}, 0($[[T0]])
  store i32 %0, i32* %c, align 4
