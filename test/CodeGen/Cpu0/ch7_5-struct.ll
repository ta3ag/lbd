...
; STATIC:  lui	$[[T0:[0-9]+]], %hi(date)
; STATIC:  addiu	$[[T1:[0-9]+]], $[[T0]], %lo(date)
; STATIC:  ld	${{[0-9]+}}, 8($[[T1]])

; PIC:  .cpload	$t9
; PIC:  lui	$[[T0:[0-9]+]], %got_hi(date)
; PIC:  addu	$[[T1:[0-9]+]], $[[T0]], $gp
; PIC:  ld	$[[T2:[0-9]+]], %got_lo(date)($[[T1]])
; PIC:  ld	${{[0-9]+}}, 8($[[T2]])
